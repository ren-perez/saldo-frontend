...
const typeBorderColors: Record<AccountType, string> = {
    checking: "border-chart-2/30",
    savings: "border-primary/30",
    investment: "border-chart-4/30",
    credit: "border-destructive/30",
};
                                            ...
                                            >
                                                <CardContent className="px-4">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        {/* <div className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg ${typeColors[acctType]}`}>
